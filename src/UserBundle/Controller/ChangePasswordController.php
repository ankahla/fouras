 ...
 */
class ChangePasswordController extends ChangePasswordBaseController
{
    use ControllerTrait;
    /**
    ...
    public function changePasswordAction(Request $request)
    {
        ...
        $tmpl = $user->isVendor() ?
            'UserBundle::Profile/Vendor/password.html.twig' :
            'UserBundle::Profile/Couple/password.html.twig';
