...
namespace Infrastructure\Controller\Front\User;

use Infrastructure\Form\ServiceType;
use Infrastructure\Form\UserParamsType;
use Model\User;
...
use Model\VendorUrl;
use Model\Task;
use Infrastructure\Form\VendorType;
use Infrastructure\Form\CoupleType;
use Infrastructure\Form\ProfilePictureFormType;
...
class UserController extends AbstractController
{
    ...
    private function createDeleteTaskForm(Task $task)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('user_delete_task', ['id' => $task->getId()]))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
