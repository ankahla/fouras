...
use CmsBundle\Form\ContentType;
...
class ContentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CmsBundle:Content')->findAll();
     ...
     * @Method("POST")
     * @Template("CmsBundle:Content:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CmsBundle:Content')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CmsBundle:Content:edit.html.twig")
     */
