...
use CmsBundle\Entity\Module;
use CmsBundle\Form\ModuleType;
...
class ModuleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CmsBundle:Module')->findAll();
     ...
     * @Method("POST")
     * @Template("CmsBundle:Module:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CmsBundle:Module')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CmsBundle:Module:edit.html.twig")
     */
