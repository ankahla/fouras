...
use CmsBundle\Entity\Item;
use CmsBundle\Form\ItemType;
...
class ItemController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CmsBundle:Item')->findAll();
     ...
     * @Method("POST")
     * @Template("CmsBundle:Item:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CmsBundle:Item')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CmsBundle:Item:edit.html.twig")
     */
