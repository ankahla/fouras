...
use CmsBundle\Entity\Media;
use CmsBundle\Form\MediaType;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CmsBundle:Media')->findAll();
     ...
     * @Method("POST")
     * @Template("CmsBundle:Media:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CmsBundle:Media')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CmsBundle:Media:edit.html.twig")
     */
