...
{
    /**
     * @Route("/admin/newsletter-subscribtion/{page}", name="admin_newsletter_subscribtion_list", requirements={"page"="\d+"})
     */
     ...
     *
     * @Route("/admin/newsletter-subscribtion/{id}/switch-activation", name="admin_newsletter_subscribtion_switch_activation")
     */
    ...
    /**
     * @Route("/admin/newsletter-subscribtion/{id}/delete", name="admin_newsletter_subscribtion_delete")
     */
