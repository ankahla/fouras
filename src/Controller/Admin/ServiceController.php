...
{
    /**
     * @Route("/admin/services", name="admin_service_list")
    ...
    public function new(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_service_list', array('id' => $service->getId()));
        }
    ...
    /**
     * @Route("/admin/service/{id}/show", name="admin_service_show")
     *
     */
    public function show($id)
    {
        ...
        return $this->render('admin/service/show.html.twig', array(
            'service' => $service,
